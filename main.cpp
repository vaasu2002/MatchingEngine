...
int main() {
    using namespace OrderEngine;
        ...
        OrderBook<Order*> ob(symbol); // Order book for "VAA" symbol
        // A resting order is one that is already in the book, waiting to be matched.
        // Seeding a resting SELL (ASK) Limit order with: id 42, at price 100, qty 4000 
